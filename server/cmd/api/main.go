...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", "postgres://postgresql:KrmYnM8RdgRmHH0othJWoWMiEdLDKjkf@dpg-cfri1m6n6mphhm2s07ng-a.oregon-postgres.render.com/armageddon", "PostgreSQL DSN")
	...
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "211452@astanait.edu.kz", "SMTP sender")
